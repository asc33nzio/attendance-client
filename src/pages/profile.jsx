...
export const Profile = ({ id }) => {
    ...
    const handleCreate = async (value) => {
        try {
            ...
            await Axios.patch(`http://localhost:3369/api/users/updateprofile`, data, {
    ...
    return (
        <>
            ...
            <Flex justifyContent="center">
                <Flex justifyContent="center" mt={{ base: "50px", md: "170px" }} borderRadius="10px" boxShadow="0px 0px 6px black" bgGradient="linear(#000000,#FFFFFF)" w={{ base: "90%", md: "700px" }} h="450px">
                    <Flex mt="48px" borderRadius="10px" justifyContent="center" boxShadow="0px 0px 6px black" bg="white" w="90%" h="350px">
                        <Box mr={{ base: 0, md: "45px" }}>
                            <Flex mt="20px" justifyContent="center" >
                                <Avatar src={`http://localhost:3369/avatars/${data.avatar}`} mt="25px" boxShadow="0px 0px 4px black" bg="grey" w={{ base: "100px", md: "230px" }} h={{ base: "100px", md: "230px" }} />
                            </Flex>
                            <Formik
                                    ...
                                    return (
                                        <Form>
                                            <Flex position="relative" justifyContent="center">
                                                ...
                                                <Flex justifyContent="center">
                                                    <Button isDisabled={!props.dirty} type="submit" w="80px" h="30px" lineHeight="30px" mt="20px" cursor="pointer" _hover={{ bg: 'green.600' }} fontSize="17px" bg="green.300" color="white">Save</Button>
                                                </Flex>
                                            </Flex>
                                        </Form>
                                    );
